...
if __name__ == "__main__":
    ...
    while True:
        ...
        print("Latitude is: ", um982_driver.bestpos_lat)         # 维度
        print("Longitude is: ", um982_driver.bestpos_lon)         # 经度

        print("UTM x is: ", um982_driver.utm_x)               # utm坐标的x（东方向为正）
        print("UTM y is: ", um982_driver.utm_y)               # utm坐标的y（北方向为正）
